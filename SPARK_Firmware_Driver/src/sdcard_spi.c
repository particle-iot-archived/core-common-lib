/**
  ...
  * @version V1.0.0
  * @date    14-April-2014
  * @brief   This file has been adapted from ST Microelectronics Eval boards and
  *          provides a set of functions needed to manage the SD Card memory
  *          interfaced to Spark Core's STM32-SPI1 peripheral.
  *          It implements a high level communication layer for read and write 
  *          from/to this memory. The needed STM32 hardware resources (SPI and 
  *          GPIO) are defined in sdcard_spi.h file, and the initialization is
  *          performed in SD_LowLevel_Init() function.
  *
  *          ===================================================================
  *          Note: 
...
void SD_LowLevel_DeInit(void)
{
  ...
  SD_SPI_CLK_CMD(SD_SPI_CLK, DISABLE);
...
void SD_LowLevel_Init(void)
{
  ...
  /* SD_SPI_CS_GPIO, SD_SPI_SCK_GPIO, SD_SPI_MISO_GPIO
     and SD_SPI_MOSI_GPIOPeriph clock enable */
  SD_SPI_CLK_CMD(SD_CS_GPIO_CLK | SD_SPI_SCK_GPIO_CLK |
		         SD_SPI_MISO_GPIO_CLK | SD_SPI_MOSI_GPIO_CLK, ENABLE);

#ifdef SD_DETECT_ENABLE
  /* SD_SPI_DETECT_GPIO Periph clock enable */
  SD_SPI_CLK_CMD(SD_DETECT_GPIO_CLK, ENABLE);
#endif
